...
from .mixins import CtegoryDetailMixin
...
class ProductDetailView(CtegoryDetailMixin, DetailView):
...
class CategoryDetailView(CtegoryDetailMixin, DetailView):
...
class AddToCartView(View):
    ...
    def get(self, request, *args, **kwargs):
        ct_model, product_slug = kwargs.get('ct_model'), kwargs.get('sslug')
